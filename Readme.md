...
ChIP-seq experiments generate genome-wide maps of TF–DNA interactions, but identifying the underlying sequence determinants of TF binding remains challenging due to:
...
#### script prepare_tfbs_datasets.sh
#### notebook CTCF_prediction.ipynb
Positive and negative FASTA files merged into a single CSV file with labels.
# workflow
![workflow](https://github.com/DOREENKDAVID/Tfbs-prediction-CNN/blob/main/cnn%20model%20illustration.svg)
...
References
Jinyu Yang, Anjun Ma, Adam D Hoppe, Cankun Wang, Yang Li, Chi Zhang, Yan Wang, Bingqiang Liu, Qin Ma, Prediction of regulatory motifs from human Chip-sequencing data using a deep learning framework, Nucleic Acids Research, Volume 47, Issue 15, 05 September 2019, Pages 7809–7824, https://doi.org/10.1093/nar/gkz672
